...
class rank_usercalinder extends StatelessWidget {
  @override
      ...
      body: Container(
        ...
        child: Container(
          ...
          child: Stack(
            children: [
              Positioned(
                // autogroupq2zjM6d (92Ast8s1VykjqDSEEaq2Zj)
                left: 0*fem,
                top: 102*fem,
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        // autogroupykjppku (92Aq5iXe9A5arA923ZYkjP)
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Container(
                                          // autogroupr8zqkCd (92AqS3H7P8C9ctndJKr8zq)
                                        ...
                                        Container(
                                          // autogroupuvfoUCV (92Aqn2hoVFqz1yevruuvfo)
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    // autogrouptue1vcm (92AukLFj84vVZWMYSPTUe1)
                ...
                child: Align(
                  child: SizedBox(
                    ...
                    child: TextButton(
                      ...
                      child: Image.asset(
                        'assets/resource/images/vector-gxm.png',
                        width: 11*fem,
                        height: 20*fem,
                      ),
                    ),
                ...
                child: Align(
                  child: SizedBox(
                    ...
                    child: TextButton(
                      ...
                      child: Image.asset(
                        'assets/resource/images/bar-chart-it5.png',
                        fit: BoxFit.contain,
                      ),
                    ),
                  ),
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        height: 16*fem,
                        child: Image.asset(
                          'assets/resource/images/home-6iR.png',
                          width: 15*fem,
                          height: 16*fem,
                        ),
                      ),
                      Container(
                        // autogroupr2mkaq3 (92AwmXPTPiXyNPN6LxR2mK)
                        margin: EdgeInsets.fromLTRB(0*fem, 0.5*fem, 78*fem, 0*fem),
                        width: 15*fem,
                        height: 24.5*fem,
                        child: Image.asset(
                          'assets/resource/images/auto-group-r2mk.png',
                          width: 15*fem,
                          height: 24.5*fem,
                        ),
                      ),
                      Container(
                        ...
                        height: 16*fem,
                        child: Image.asset(
                          'assets/resource/images/mydata-861.png',
                          width: 15*fem,
                          height: 16*fem,
                        ),
                      ),
                      Container(
                        ...
                        height: 5*fem,
                        child: Image.asset(
                          'assets/resource/images/-wxh.png',
                          width: 21*fem,
                          height: 5*fem,
                        ),
                      ),
