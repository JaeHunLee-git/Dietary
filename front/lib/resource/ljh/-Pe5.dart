...
class Pe5 extends StatefulWidget {
  @override
  _Pe5State createState() => _Pe5State();
}

class _Pe5State extends State<Pe5> {
  int userInput = 0; // 사용자 입력을 저장할 변수
                      ...
                      Container(
                        ...
                        child: Center(
                          child: Center(
                            child: TextButton(
                              onPressed: () {
                                // Navigate to MainPage when button is pressed
                        ...
                        child: Stack(
                          children: [
                            Positioned(
                              ...
                              top: 491.5 * fem,
                              child:
                                  Container(width: 286 * fem, height: 25 * fem),
                            ),
                            Positioned(
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                width: 200 * fem, // 텍스트 입력을 위한 더 넓은 공간
                                height: 43 * fem,
                                decoration: BoxDecoration(
                                  color: Color(0xffd9d9d9),
                                  borderRadius: BorderRadius.circular(10 * fem),
                                ...
                                child: Row(
                                  children: [
                                    Expanded(
                                      child: TextFormField(
                                        keyboardType: TextInputType.number, // 숫자 키패드를 보여줌
                                        onChanged: (value) {
                                          // 입력 값이 변경될 때 호출되는 콜백
                                          try {
                                            userInput = int.parse(value); // 문자열을 정수로 변환하여 저장
                                          } catch (e) {
                                            // 유효하지 않은 숫자가 입력되면 처리
                                            userInput = 0; // 기본값 또는 다른 적절한 처리
                                          }
                                        },
                                        style: SafeGoogleFont(
                                          'Inter',
                                        ...
                                        decoration: InputDecoration(
                                          border: InputBorder.none, // 입력 테두리 제거
                                        ),
                                      ),
                                    ),
                                    SizedBox(width: 5), // 숫자와 '분' 사이에 간격을 두기 위해 추가
                                    Text(
                                      '분',
                                      style: SafeGoogleFont(
                                        'Inter',
